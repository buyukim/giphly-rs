...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
        com.giphly.service.EmailAlreadyUsedException ex,
    ...
    public ResponseEntity<Problem> handleUsernameAlreadyUsedException(
        com.giphly.service.UsernameAlreadyUsedException ex,
        NativeWebRequest request
    ) {
    ...
    public ResponseEntity<Problem> handleInvalidPasswordException(
        com.giphly.service.InvalidPasswordException ex,
        NativeWebRequest request
    ) {
    ...
    public ResponseEntity<Problem> processDataIntegrityViolationException(DataIntegrityViolationException ex, NativeWebRequest request) {
        Problem problem = Problem
            ...
            .with(MESSAGE_KEY, ErrorConstants.ERR_VALIDATION_DUPLICATE)
            .build();
        return create(ex, problem, request);
    }
