 ...
 */
@ApiModel(description = "The Giphy User Object contains information about the user associated with a GIF and URLs to assets such as that user's avatar image, profile, and more.")
...
public class GiphyUser   {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.avatarUrl, giphyUser.avatarUrl) &&
